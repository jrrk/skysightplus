/*
	...
	for the Parallel Port driver.  This supports the ST-7,
	ST-8, ST-5C (PixCel255), ST-237 (PixCel237) and the
	Industrial ST-K	cameras.

	It also supports the TCE-1 Telescope Control Electronics and
	the AO-7.

    Version 2.70 - May 6, 1999
...
typedef enum {
	...
	*/
	...
	CC_ESTABLISH_LINK, CC_GET_DRIVER_INFO, CC_GET_CCD_INFO,
	CC_QUERY_COMMAND_STATUS, CC_MISCELLANEOUS_CONTROL,
    ...
    CC_GET_TURBO_STATUS, CC_END_READOUT,
	...
	*/
	CC_SEND_BLOCK, CC_SEND_BYTE, CC_GET_BYTE, CC_SEND_AD,
...
*/
typedef enum { CE_NO_ERROR, CE_CAMERA_NOT_FOUND,
	CE_EXPOSURE_IN_PROGRESS, CE_NO_EXPOSURE_IN_PROGRESS,
	CE_UNKNOWN_COMMAND, CE_BAD_CAMERA_COMMAND, CE_BAD_PARAMETER,
	CE_TX_TIMEOUT, CE_RX_TIMEOUT, CE_NAK_RECEIVED,
	CE_CAN_RECEIVED, CE_UNKNOWN_RESPONSE, CE_BAD_LENGTH,
	CE_AD_TIMEOUT, CE_KBD_ESC, CE_CHECKSUM_ERROR, CE_EEPROM_ERROR,
	CE_SHUTTER_ERROR, CE_UNKNOWN_CAMERA,
	CE_DRIVER_NOT_FOUND, CE_DRIVER_NOT_OPEN, CE_DRIVER_NOT_CLOSED,
	CE_SHARE_ERROR, CE_TCE_NOT_FOUND, CE_AO_ERROR,
...
#define FALSE 0
#define TRUE 1
typedef enum { DRIVER_STD } DRIVER_REQUEST;
...
typedef enum { BASE_ADDR, PORT0, PORT1, PORT2 } PORT;
...
typedef enum { ST7_CAMERA=4, ST8_CAMERA, ST5C_CAMERA, TCE_CONTROLLER,
  ST237_CAMERA, STK_CAMERA } CAMERA_TYPE;
...
#elif TARGET == ENV_WIN
  #ifdef __cplusplus
	"C" short __export ParDrvCommand(short command, void far *Params, void far *Results);
	"C" short __export TCEDrvCommand(short command, void far *Params, void far *Results);
  #else
	short __export  ParDrvCommand(short command, void far *Params, void far *Results);
	short __export  TCEDrvCommand(short command, void far *Params, void far *Results);
  #endif
#else
  #ifdef __cplusplus
	extern "C" __declspec(dllexport) short ParDrvCommand(short command, void*Params, void*Results);
	extern "C" __declspec(dllexport) short TCEDrvCommand(short command, void*Params, void*Results);
  #else
	extern __declspec(dllexport) short ParDrvCommand(short command, void*Params, void*Results);
	extern __declspec(dllexport) short TCEDrvCommand(short command, void*Params, void*Results);
  #endif
#endif
