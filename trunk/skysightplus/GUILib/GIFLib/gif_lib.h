...
#define GIF87_STAMP	"GIF87a"         /* First chars in file - GIF 87a stamp. */
#define GIF89_STAMP	"GIF89a"         /* First chars in file - GIF 89a stamp. */
#define GIF_STAMP	"GIFVER"	     /* First chars in file - GIF stamp. */
#define GIF_STAMP_LEN	6		     /* Size of GIF stamp */
#define GIF_VERSION_POS	3		     /* Postion of first version character in stamp. */
...
typedef struct GifFileType {
	GifByteType Version[GIF_STAMP_LEN];		/* Version stamp */
...
int EGifPutGraphicControlExtension ( GifFileType *GifFile, int DisposalMethod,
	GifBooleanType UserInput, short DelayTime, GifBooleanType TransparencyFlag,
...
int DGifGetGraphicControlExtension ( GifByteType *Extension, int *DisposalMethod,
	GifBooleanType *UserInput, unsigned short *DelayTime,
